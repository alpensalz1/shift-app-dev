...
/* ── Matrix Admin Overlay (full screen) ── */
export function MatrixAdminOverlay({
  adminToken,
  setAdminToken,
  adminError,
  adminLoading,
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      {showAccepted && (
        <div className="fixed inset-0 flex items-center justify-center pointer-events-none" style={{ zIndex: 35 }}>
          <div style={{
            ...
            <p style={{ color: '#00cc44', fontFamily: 'monospace', fontSize: '10px', letterSpacing: '0.22em', marginBottom: '14px', textTransform: 'uppercase', opacity: 0.75 }}>
              ✓ &nbsp; authentication&nbsp;successful
            </p>
            <p style={{ color: '#00ff88', fontFamily: 'monospace', fontSize: '24px', fontWeight: 'bold', letterSpacing: '0.07em', textShadow: '0 0 24px rgba(0,255,100,0.9), 0 0 48px rgba(0,255,100,0.4)', marginBottom: '10px' }}>
              PASSCODE ACCEPTED
            </p>
            <p style={{ color: '#ffffff', fontFamily: 'monospace', fontSize: '15px', letterSpacing: '0.05em', opacity: 0.9, textShadow: '0 0 12px rgba(255,255,255,0.6)', animation: 'welcomeFade 0.4s ease-out 0.45s both' }}>
              Welcome {adminName}&nbsp;&nbsp;^_^
            </p>
            <div style={{ marginTop: '18px', height: '1px', background: 'linear-gradient(90deg, transparent, rgba(0,255,70,0.5), transparent)' }} />
            <p style={{ color: '#00ff44', fontFamily: 'monospace', fontSize: '9px', letterSpacing: '0.18em', marginTop: '10px', opacity: 0.45 }}>
      ...
      {/* CRT flicker */}
      <div className="fixed inset-0 z-10 pointer-events-none" style={{ animation: 'flicker 0.15s infinite', boxShadow: 'inset 0 0 120px rgba(0,255,0,0.05)' }} />
      ...
      <div className="relative z-20 flex items-center justify-center min-h-screen px-4">
        <div className="w-full max-w-lg">
          <div className="bg-green-900/40 border border-green-500/30 rounded-t-lg px-4 py-2 flex items-center justify-between backdrop-blur-sm">
            ...
            <button onClick={onBack} className="text-green-500/50 hover:text-green-400 text-xs font-mono transition-colors">
              [ESC]
            </button>
          </div>
          ...
          <div className="bg-black/90 border border-t-0 border-green-500/30 rounded-b-lg p-6 backdrop-blur-sm min-h-[320px]">
            ...
            {phase === 'input' && (
              <div className="space-y-4 mt-4">
                ...
                <form onSubmit={(e) => { e.preventDefault(); setPhase('auth'); onSubmit() }} className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button type="button" onClick={onBack} className="bg-transparent border border-green-500/30 text-green-600 py-2 px-4 rounded font-mono text-sm hover:border-green-500/50 hover:text-green-400 transition-colors">
                      [ EXIT ]
                    </button>
                  </div>
                </form>
            ...
            {phase === 'success' && (
              <div className="space-y-1.5 mt-4 font-mono text-xs">
                ...
                <p className="text-green-400">[OK] Identity confirmed: <span className="text-white font-bold">{adminName.toUpperCase()}</span></p>
